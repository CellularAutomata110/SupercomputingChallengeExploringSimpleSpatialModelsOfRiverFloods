import os
from readers.statements import section_starts, include_mark
import readers.ColorMap as colormap_readers
import readers.ReadInitialState as grid_state_readers
import readers.Height as height_readers
'''
For external use
'''
...
def parse_manifest_stream(manifest_stream):
    ...
    for line in manifest_stream:
        ...
        elif line.startswith(section_starts['height']):
            options['height'] = \
                         height_readers.parse_height_stream(manifest_stream)
