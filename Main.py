...
import readers.ReadInitialState
import readers.ColorMap
import readers.manifest_readers
import readers.ordered_dict
import readers.statements

import os

from simulators.synchronous_simulator import SynchronousSimulator
from views.time_display import TimeDisplay
from views.text_display import TextDisplay
from views.grid_display import SquareGridDisplay, HexGridDisplay
from views.legend_display import LegendDisplay
from simulators.event_history import EventHistory

from pygbutton import PygButton
from options.option_processor import SynchronousCellularAutomataOptionParser
...
def main():
    ...
    simulate_flooding(manifest_filename)
